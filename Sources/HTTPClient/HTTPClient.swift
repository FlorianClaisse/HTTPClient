...
public actor HTTPClient {
    ...
    public struct Configuration: @unchecked Sendable {
        ...
        public init(baseURL: URL?, sessionConfiguration: URLSessionConfiguration = .default, delegate: HTTPClientDelegate? = nil) {
    ...
    /// - Parameters:
    ///   - baseURL: A base URL. For example, `"https://api.github.com"`.
    ///   - configure: Updates the client configuration.
    public init(baseURL: URL?, _ configure: @Sendable (inout HTTPClient.Configuration) -> Void = { _ in }) {
    ...
    ///   - baseURL: A base URL. For example, `"https://api.github.com"`.
    ///   - configure: Updates the client configuration.
    public convenience init(baseURL: URL?, _ configure: (inout HTTPClient.Configuration) -> Void = { _ in }) {
        var configuration = Configuration(baseURL: baseURL)
        configure(&configuration)
        self.init(configuration: configuration)
    }
    ...
    @discardableResult public func send(_ request: Request<Void>, delegate: URLSessionDataDelegate? = nil, configure: ((inout URLRequest) throws -> Void)? = nil
