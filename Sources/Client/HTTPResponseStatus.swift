...
//
//
//  Created by Florian Claisse on 16/11/2023.
//

/// A HTTP response status code
public enum HTTPResponseStatus: Sendable, Encodable, Hashable {
    ...
    public var mayHaveResponseBody: Bool {
        switch self {
        case .`continue`, .switchingProtocols, .processing, .noContent,
    ...
    public var code: UInt {
        get {
            ...
            case .custom(code: let code, reasonPhrase: _): return code
            }
        }
    }
    ...
    public var reasonPhrase: String {
        get {
            ...
            case .custom(code: _, reasonPhrase: let phrase): return phrase
            }
        }
    }
}
